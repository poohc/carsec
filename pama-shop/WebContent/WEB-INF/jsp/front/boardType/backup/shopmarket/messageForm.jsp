			...
			<div class="board_write3">
				<table>
					...
					<thead>
                        ...
                        <tr>
							<th><label for="title">지역</label></th>
							<th colspan="3" class="t_l"><span class="enter_st enter_st1"><input type="text" name="varFiled1" class="title" title="지역" value="${messageVO.varFiled1}"></span></th>
						</tr>
						 <tr>
							<th><label for="title">보증금</label></th>
							<th colspan="3" class="t_l"><span class="enter_st enter_st1"><input type="text" name="varFiled2" class="title" title="보증금" value="${messageVO.varFiled2}"></span></th>
						</tr>
						 <tr>
							<th><label for="title">월세</label></th>
							<th colspan="3" class="t_l"><span class="enter_st enter_st1"><input type="text" name="varFiled3" class="title" title="월세" value="${messageVO.varFiled3}"></span></th>
						</tr>
						 <tr>
							<th><label for="title">권리금</label></th>
							<th colspan="3" class="t_l"><span class="enter_st enter_st1"><input type="text" name="varFiled4" class="title" title="권리금" value="${messageVO.varFiled4}"></span></th>
						</tr>
						 <tr>
							<th><label for="title">현업종</label></th>
							<th colspan="3" class="t_l"><span class="enter_st enter_st1"><input type="text" name="varFiled5" class="title" title="현업종" value="${messageVO.varFiled5}"></span></th>
						</tr>
