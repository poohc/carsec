...
<body>
	<ul class="recuit_list">
		<li class="">${fn:substring(messageVO.registerDate, 0, 10)}</li>
		<li class="">${messageVO.registerName}</li>
		<li class="type1">${messageVO.varFiled3} ${messageVO.varFiled4}</li>
		<li class="type1">${messageVO.varFiled1}</li>
		<li class="type1">${messageVO.varFiled2}</li>
		<li class="type1">${messageVO.title}</li>
		<li class="type1">${messageVO.varFiled5}-${messageVO.varFiled6}-${messageVO.varFiled7}</li>
	</ul>
