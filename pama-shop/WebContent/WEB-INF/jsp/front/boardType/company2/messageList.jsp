...
<body>
	<img src="/img/bullet/bullet_company2.png"/>
			...
			<form name="messageSearchForm" method="post">
				...
				<select id="varFiled5" name="varFiled5" title="선택하세요">
					<option value="">서비스 품목</option>
                     ...
                     <option value="부품대리점" <c:if test="${param.varFiled5=='부품대리점'}"> selected</c:if>>부품대리점</option>
		...
		<table>
			...
			<tbody>
				<c:forEach items="${messageList.messageList }" var="i" varStatus="iStatus">
					<tr>
						<td>${i.varFiled1}</td>
						<td>${fn:replace(i.varFiled3,'-',' ')}&nbsp;&nbsp;${i.varFiled4}</td>
						<td>${i.varFiled5}</td>
						<td>${i.varFiled6}</td>
					</tr>
				</c:forEach>
