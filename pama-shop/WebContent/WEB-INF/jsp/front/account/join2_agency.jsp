...
<body>
    ...
    <div id="container">
        <div class="join_type1">
            ...
            <form name="accountForm" id="accountForm" method="post" class="accountForm" action="accountAgencyJoinProc.do">
                ...
                <div class="member_join">
                    <fieldset class="phone_name">
                        ...
                        <input type="text" id="pwd" name="pwd" placeholder="영,숫자 조합 8자리 이상" class="m_t5" title="비밀번호 입력" data-from="text">
                        <label for="password2">비밀번호 재입력</label>
                        <input type="text" id="pwdchk" name="pwdchk" placeholder="비밀번호 재입력" class="m_t5" title="비밀번호 재입력" data-from="text">
                    </fieldset>
