								...
								<tbody>
									...
									<tr>
 									...
 									<tr>
 										...
 										<td><input type="text" id="mobile" name="mobile" class="inpText" placeholder="(-없이)입력" class="required" onChange="fieldserv('mobile')" /> <a href="#" class="leftmag"><img src="/join_form_img/sub/bt_overlap.png" align="absmiddle" alt="인증번호발송" onClick="getCert();" /></a></td>
 									</tr>

 									<tr>
 										<th scope="row"><label for="comp_id">인증번호입력</label> <span class="warning">*</span></th>
 										<td><input type="text" name="certification" id="certification" class="inpText" placeholder="인증번호입력" class="required"  /> <a href="#" class="leftmag"><img src="/join_form_img/sub/bt_overlap.png" align="absmiddle" alt="인증하기" onClick="getCertResult()"/></a></td>
 									</tr>
									<tr>
