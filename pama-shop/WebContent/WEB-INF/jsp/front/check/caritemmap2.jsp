                ...
                <form action="check3.jsp">
                    ...
                    <div class="right_map">
                        ...
                        <div class="img_box2">
		            			...
		            			<c:if test="${carfile1=='N'}"><img src="/img/map_mimg_bg.png"/></c:if>


                        </div>
                        <div class="img_box">

                        		 <c:set var="carfile2" value="N"/>
                                 <c:forEach items="${message.attachmentList}" var="i" varStatus="iStatus">
					            	<c:if test="${i.showIndex==2}">
					            		<c:set var="carfile2" value="Y"/>
										<img src="/media/${i.fileName}.image" width="213px" height="138px"  alt="${message.title}"/>
									</c:if>
					            </c:forEach>
		            			<c:if test="${carfile2=='N'}"><img src="/img/map_simg_bg.png"/></c:if>
                        ...
                        <dl>
                            <dt>${message.title}</dt>
                            <dd>
                            ${fn:replace(message.summaryContents,crcn,br)}
                            </dd>
                        </dl>
