		...
		<div class="terms_detail agree_wrap">
			...
			<div class="information">
				...
				<div class="bx">
					...
					동안 회원정보 및 홈페이지 서비스 이용 시 발생한 정보를 보관합니다. - 전자금융거래기록의 생성 및 보존 : 5년 (전자금융거래법) - 대금결제 및 재화 등의 공급에 관한 기록 : 5년 (전자상거래등에서의 소비자보호에 관한 법률) - 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 (전자상거래등에서의 소비자보호에 관한 법률) - 계약 또는 청약철회 등에 관한 기록 : 5년 (전자상거래등에서의 소비자 보호에 관한 법률)<br /> 본인은 귀사가 본인에 관한 정보 제공하는데 동의합니다.
				</div>
