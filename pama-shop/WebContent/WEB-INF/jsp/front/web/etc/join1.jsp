    		...
    		<div class="bbs">
         					   ...
         					   <p class="joinFieldText">* 표시된 항목은 반드시 입력/선택 해야합니다. </p>
            					  ...
            					  <colgroup>
        					       ...
        					       <col width="850" />
              					  ...
              					  <tbody>
                <tr>
                  <th scope="row"> <label for="comp_name">사업자명</label>
                ...
                <tr>
                  <th scope="row"> <label for="comp_num">사업자등록번호</label>
                    <span class="warning">*</span> </th>
                  <td><input type="text" id="comp_num" class="inpText" /><span> ('-' 없이 입력하세요) </span> </td>
                </tr>
                <tr>
                ...
                <tr>
                  <th scope="row"> <label for="ceo_pw">대표자명</label>
                    <span class="warning">*</span> </th>
                  <td><input type="text" id="ceo_pw" class="inpText" /></td>
                </tr>
                <tr class="email_bx">
                  <th scope="row"> <label for="ceo_email">대표 이메일 </label>
                   </th>
                ...
                <tr class="phone">
                  <th scope="row" > <label for="comp_num1">사업장 전화번호</label>
                    <span class="warning">*</span> </th>
                  <td><span class="select_box" >선택하세요</span>
                ...
                <tr class="adress_bx">
                  ...
                  <p /><br>
                  이미지가 없을 경우 FAX : 031 - 777 -7777로 보내주시면 승인해 드립니다.
                  </td>
                </tr>
                <tr class="adress_bx">
                 ...
                 <tr class="adress_bx">
                  <th scope="row"> <label for="comp_adress">서비스품목</label>
                  </th>
                  <td>
                   <span class="select_box" >서비스 품목 1</span>
                   ...
                   <p /><br>
                   <span class="select_box" >서비스 품목 2</span>
                    <select id="user_bank" title="선택하세요" class="select_dd">
                    <option value="">1급공업사</option>
                                    <option value="">2급공업사</option>
                                    <option value="">기본 경정비</option>
                   ...
                   <p /><br>
                   <span class="select_box" >서비스 품목 3</span>
                    <select id="user_bank" title="선택하세요" class="select_dd">
                    <option value="">1급공업사</option>
                                    <option value="">2급공업사</option>
                                    <option value="">기본 경정비</option>
                   ...
                   <p /><br>
                   <span class="select_box" >서비스 품목 4</span>
                    <select id="user_bank" title="선택하세요" class="select_dd">
                    <option value="">1급공업사</option>
                                    <option value="">2급공업사</option>
                                    <option value="">기본 경정비</option>
                   ...
                   <p /><br>
                   <span class="select_box" >서비스 품목 5</span>
                    <select id="user_bank" title="선택하세요" class="select_dd">
                    <option value="">1급공업사</option>
                                    <option value="">2급공업사</option>
                                    <option value="">기본 경정비</option>
