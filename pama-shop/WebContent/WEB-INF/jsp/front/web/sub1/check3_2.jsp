    ...
    <div id="container">
        <div class="content">
            <ul class="tablist check_part">
                <li class=""><a href="/web/sub1/check1.do">내차 SELF 점검</a></li>
                <li class="on"><a href="/web/sub1/check3.do"><i class="fa fa-heartbeat"></i> 차량 부품 Map</a></li>
            </ul>
            <div class="part_map">
        ...
        <div class="part_detailbox">
            <p>헤드램프<span>HEAD LAMP</span></p>
            <ul>
                <li><img src="/img/map2.jpg" alt=""></li>
                <li><img src="/img/map2.jpg" alt=""></li>
            </ul>
        </div>
        </div>
        <div class="rnb">
            ...
            <form action="check1.html">
                <div class="private_info">
                    ...
                    <a href="/web/etc/password.do" class="modify a_style">회원정보수정</a>
                </div>
            </form>
