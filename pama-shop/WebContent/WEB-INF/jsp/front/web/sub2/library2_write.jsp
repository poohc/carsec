            ...
            <div class="layout_type1">
                ...
                <form action="library2.do">
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="t_l"><span class="enter_st enter_st2"><input type="text" id="author" title="작성자"></span></th>
                                    <th class="t_bg"><label for="kindof">유형</label></th>
                                    <th class="t_l">
                                        <span class="selectbox type2">
                                            <select id="number" title="유형">
                                                <option value="">보험관련 고민</option>
                                                <option value="">사고관련 고민</option>
                                                <option value="">에피소드</option>
                                            </select>
                                        </span>
                                    </th>
                                </tr>
                    ...
                    <div class="btn_right">
                        ...
                        <button type="submit" class="button_type1">등록하기</button>
                    </div>
                </form>
