    ...
    <div id="container">
        <div class="content">
            <ul class="tablist check_part">
                ...
                <li class=""><a href="/web/sub2/library9.do">당첨자 공지</a></li>
            </ul>
            <div class="layout_type1">
                ...
                <ul class="event_layout">
                    <li class="first">
                        <a href="/web/sub2/library9_view.do">
                            <img src="/img/event1.jpg" alt="ford특별시승이벤트">
                            <p class="event_title">FORD 특별 시승 이벤트</p>
                            <span>진행중</span>
                            <p class="term">2015-07-01 ~ 2015-07-31</p>
                        </a>
                    </li>
                    <li class="second">
                        <a href="/web/sub2/library9_view.do">
