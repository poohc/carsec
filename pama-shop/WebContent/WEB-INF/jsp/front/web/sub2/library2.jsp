        ...
        <div class="content">
            ...
            <div class="layout_type1">
                ...
                <div class="write_search">
                    <form action="">
                        <div class="left_area">
                            <a href="/web/sub2/library2_write.do" class="btn_search type3" title="글쓰기">글쓰기</a>
                        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2015-06-10</td>
                                <td>마스터</td>
                                <td class="left"><a href="/web/sub2/library2_view.do">내차 셀프 점검 자유게시판 제목을 게시합니다.</a></td>
                                <td>4</td>
                            </tr>
                            <tr>
                                <td>보험관련 고민</td>
