    ...
    <div id="container">
        <div class="content">
            <ul class="tablist check_part">
                <li class="on"><a href="/web/sub4/mechanic1.do">신차</a></li>
            ...
            <div class="layout_type1">
                ...
                <dl class="event">
                    <dt>Tip!</dt>
                    <dd>쇼핑몰 상품 등록 문의는 전화 또는 1:1 문의로 남겨주세요</dd>
                </dl>
                <ul class="gallery_layout2">
                    <li class="on">
                        <a href="/web/sub4/mechanic1_view.do">
                            <img src="/img/gallery2.jpg" alt="bmw신차">
                            <div class="gallery_introbox">
                                <h1 class="elipsis">뛰어난 연비를 자동하는 BMW 신차를 소개 합니다.</h1>
                                <p>아우디의 엔트리 모델, 소형 해치백 A1이 국내 출시됐다. A1의 판매 가격은 3,270만원부터 3,720만원까지. A3 세단과 스포트백이 3,650만원부터인것을 감안하면 다소 의아한 가격 책정이..</p>
                                <span>카색매니져</span>
        ...
        <div class="rnb">
            ...
            <form action="check1.html">
                <div class="private_info">
                    ...
                    <p class="names_box"><span class="names">송도카센터</span></p>
                    ...
                    <a href="/web/etc/member_modify.do" class="modify a_style">수정</a>
                </div>
            </form>
            <div class="banner">
                <ul>
