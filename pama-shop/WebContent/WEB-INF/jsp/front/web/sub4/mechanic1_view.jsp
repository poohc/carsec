    ...
    <div id="container">
        <div class="content">
            <ul class="tablist check_part">
                ...
                <li class=""><a href="/web/sub4/mechanic6.do">정비 업체리스트</a></li>
                ...
                <div class="comment">
                    ...
                    <form action="freeboard_view.jsp">
                        <ul class="comment_list">
                            <li class="need_login">
                                <textarea name="comment" placeholder="댓글 작성을 위해 로그인 해주세요." id="comment" cols="30" rows="10" title="제목/내용" value="댓글 작성을 위해 로그인 해주세요." class="first_comm bb_1"></textarea>
                        ...
                        <div class="center_box">
                            <a href="/web/sub4/mechanic1.do" class="btn_type1">목 록</a>
                        </div>
                    </form>
                </div>
            </div>
