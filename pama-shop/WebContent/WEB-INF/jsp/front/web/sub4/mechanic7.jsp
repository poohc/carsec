    ...
    <div id="container">
        <div class="content">
            <ul class="tablist check_part">
                ...
                <li class="on"><a href="/web/sub4/mechanic7.do">정비외 업체리스트</a></li>
                        ...
                        <form>
                            ...
                            <span class="selectbox type2">
                                <select id="kind" title="서비스품목">
                                    <option value="">폐차서비스</option>
                                    <option value="">중고부품 매매</option>
                                    <option value="">중고차매입</option>
                                    <option value="">자동차악세사리</option>
                                    <option value="">재생타이어</option>
                                    <option value="">재생부품업체</option>
                                    <option value="">보험관련업체</option>
                                </select>
                            </span>
