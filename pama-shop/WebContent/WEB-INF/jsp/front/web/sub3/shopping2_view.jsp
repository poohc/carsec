    ...
    <div id="container">
        ...
        <div class="content0">
            <ul class="tablist check_part">
                ...
                <li class="on"><a href="/web/sub3/shopping2.do">뷰티샵</a></li>
                <li class=""><a href="/web/sub3/shopping3.do">Culture</a></li>
            </ul>
            <div class="category">
                <div class="category_tit"><span>뷰티샵카테고리</span><a href="#" class="alarm">쇼핑 알림 &gt; 쇼핑 쿠폰제도에 대하여 알려드립니다.</a></div>
        ...
        <div class="content3">
            <img src="/img/coupon/mission_thum.jpg" alt="엔진오일" class="product_view1">
            <div class="buy_box">
                <p class="buy_num">상품번호 : 202321233</p>
                <h1>캐스트롤 TRANSMAX</h1>
                <p><span>판매가</span><em>145,000 <b>원</b></em></p>
        ...
        <div class="container2">
            <div class="content2">
                ...
                <div class="img_zone"><img src="/img/coupon/shopping_detail.jpg" alt="상품상세이미지"></div>
                <dl class="dl_type2">
                    <dt>협력업체 소개</dt>
