...
<body>
    ...
    <div id="container">
        ...
        <div class="content0">
            ...
            <div class="category">
                <div class="category_tit"><span>Culture카테고리</span><a href="#" class="alarm">쇼핑 알림 &gt; 쇼핑 쿠폰제도에 대하여 알려드립니다.</a></div>
        ...
        <div class="content3">
            ...
            <div class="buy_box">
                <p class="buy_num">상품번호 : 0000000</p>
                <h1>아르마이드 세라믹 편수냄비 18cm</h1>
                <p><span>판매가</span><em>20,000 <b>원</b></em></p>
                ...
                <a href="/web/sub3/shopping_payment.do"><input type="submit" value="주문하기" class="input_type4">
            </div>
        </div>
