            ...
            <div class="layout_type1">
                ...
                <div class="board_list2">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td class="img"><a href="/web/sub5/usedcar_view.do"><img src="/img/usedcar.jpg" alt="중고차사진1"></a></td>
                                <td class="t_left">
                                    <a href="/web/sub5/usedcar_view.do">
                                        <p class="used_p">현대 YF소나타 Y20 프리미어 최고급형</p>
                                        <ul class="list_type5">
                                            <li>홍길동</li>
                                            <li>010-1234-4567</li>
                                        </ul>
               ...
               <a href="/web/sub5/usedcar_write.do"><input type="submit" class="input_type6" value="등록">
            </div>
        </div>
        <div class="rnb">
