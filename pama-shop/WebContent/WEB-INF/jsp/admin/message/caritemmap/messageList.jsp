	    ...
	    <li class="btnFr">
		    ...
		    <div class="searchinput">
			    ...
			    <select name="searchColumn">
			    	...
			    	<option value="title"${messageList.messageSearchVO.searchColumn=='title'?' selected':''}>부품명</option>
			    </select>
    ...
    <!-- //Loop -->
        <c:forEach items="${messageList.messageList}" var="i" varStatus="iStatus">
            <tr>
                ...
                <td align="center">${i.subTitle}</td>
                <td align="center">${i.messageCategoryName}</td>
                <td align="center">
                ...
                <td align="center">
                	<c:if test="${fn:length(i.showFile2) > 0}">
                	<img src="/media/${i.showFile2}.image" width="228px" height="142px">
                	</c:if>
                </td>
                <td align="center">${i.summaryContents}</td>
                <td align="center">${i.varFiled1}</td>
            </tr>
        </c:forEach>
	<!-- Loop// -->
    </tbody>
