    ...
    <tbody>
        <c:forEach items="${messageList.messageList}" var="i" varStatus="iStatus">
            <tr>
                ...
                <p>[제목]<a href="javascript:goMessageForm('${i.messageId}');">${i.title}</a></p>
                <p>[업체명] ${i.varFiled1}</p>
                <p>[주  소] ${fn:replace(i.varFiled2,'-',' ')} ${i.varFiled3}</p>
                <p>[정비품목] ${not empty i.varFiled5?i.varFiled5:''}&nbsp;&nbsp;${not empty i.varFiled4?i.varFiled4:''}&nbsp;&nbsp;${not empty i.varFiled7?i.varFiled7:''}&nbsp;&nbsp;${not empty i.varFiled8?i.varFiled8:''}&nbsp;&nbsp;${not empty i.subTitle?i.subTitle:''}</p>
                <p>[전화번호]  ${i.varFiled6}</p>
                <p>[직원수]  ${i.messageVarFiledsVO.varFileds1}</p>
                <p>[리프트수]  ${i.messageVarFiledsVO.varFileds2}</p>
                </td>
            </tr>
        </c:forEach>
	<!-- Loop// -->
